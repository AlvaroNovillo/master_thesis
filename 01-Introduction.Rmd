...
```{r rank-xg-xga, out.width='80%', fig.align='center', fig.cap= "Ranking of the average differences in Expected Goals Scored (xG) Minus Expected Goals Conceded by Opponents (xGa) per team.",echo = FALSE}
knitr::include_graphics("imagenes/xG-xGa.png")
```
...
[^2]: Opta uses a combination of human annotation, computer vision, and
