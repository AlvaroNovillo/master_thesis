...
[^5]: We assign the goalkeepers to have a higher control rate, $\lambda_{GK} = 12.9$ $s^{-1}$, to ensure that they are likely to claim the ball if it is near them and also to account for the ability of grabbing the ball with their hands