...
Then,	maximizing	the	product	of	the	likelihood	for	each	pass for a training sample P from tracking and event data from the 2015-2016 Premier League season, the best fit is found at $\sigma=0.45 \pm 0.05 \mathrm{~s} \text { and } \lambda=4.30 \pm 1.14 \mathrm{~s}^{-1}$[^5]
