...
\date{Last modified on 2024-04-29}
...
\begin{table}[!h]
\centering
\caption{\label{tab:ranking-tab}Average Effective Offside Control values and Efficiency for each team from the Spanish national league (LaLiga Santander) during the season 2019/2020, ordered by their ranking}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{tabular}[t]{lrr}
\toprule
